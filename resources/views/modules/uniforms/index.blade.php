			...
			<tbody>
				...
				@foreach($uniforms as $uniform)
					<tr>
						...
						<td>
							<a href="{{ route('uniform.edit',$uniform->id) }}" title="EDITAR" class="bj-btn-table-edit"><i class="fas fa-edit"></i></a>
							<!--<a href="{{ route('uniform.delete',$uniform->id) }}" title="EDITAR" class="bj-btn-table-delete edit-city" onclick="return confirm('¿Desea eliminar el concepto de uniforme y los registros relacionados?')"><i class="fas fa-trash-alt"></i></a>-->
						</td>
					</tr>
				@endforeach
			</tbody>

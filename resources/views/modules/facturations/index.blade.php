...
@section('financialModules')
	<div class="col-md-12">
		...
		@if(isset($all) && $all != null)
			...
			<div class="row  p-2 border-top border-right border-bottom border-left text-center">
				<div class="col-md-12">
					<button type="button" class="bj-btn-table-add btn-getModal mt-3">GENERAR FACTURA</button>
				</div>
			</div>
				...
				<div class="modal-content p-4">
					...
					<div class="modal-body p-2">
						...
						<div class="row text-center">
							<div class="col-md-12">
								<button type="button" class="bj-btn-table-add btn-saveFacture">CONTINUAR</button>
							</div>
						</div>
					</div>
				</div>

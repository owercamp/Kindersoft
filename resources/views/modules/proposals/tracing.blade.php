			...
			<tbody>
				@foreach($tracings as $tracing)
					<tr>
						...
						@endif
						<td>
							<!--<a href="#" title="EDITAR" class="bj-btn-table-edit"><i class="fas fa-edit"></i></a>-->
							...
							<button type="button" title="BITACORA" class="bj-btn-table-edit seeModalBinnacle">
	        	...
	        	<div class="col-md-12 d-flex">
        			<form id="formForApproved" action="{{ route('aprovedToProposal') }}" method="POST">
	        			...
	        			<div class="form-group">
							...
							<button type="submit" id="btnForApprove" class="bj-btn-table-add mx-3"><i class="fas fa-check-circle"></i> APROBADO</button>
	        			</div>
	        		</form>
	        		<form id="formForDenied" action="{{ route('deniedToProposal') }}" method="POST">
	        			...
	        			<div class="form-group">
							...
							<button type="submit" id="btnForNotApprove" class="bj-btn-table-edit mx-3"><i class="fas fa-times-circle"></i> DENEGADO</button>
	        			</div>
	        		</form>
	      	...
	      	<div class="row modal-body">
	        	<div class="col-md-12">
					<form action="{{ route('binnacle.save') }}" method="POST">
						...
						<div class="form-group">
							<button type="submit" class="bj-btn-table-add">GUARDAR REGISTRO</button>
						</div>
					</form>
...
@section('scripts')
	<script>
		...
		$('.seeModalWithInfo').on('click',function(){
			...
			$.get("{{ route('importAllProposal') }}", {proposalSelected: proposalId}, function(objectProposal){
		...
		$('.seeModalBinnacle').on('click',function(){
			...
			$.get("{{ route('getHistoryBinnacle') }}",{proposalId: proposalId},function(objectHistory){

		...
		<div class="card col-md-12">
			<div class="row">
				...
				<div class="col-md-6 align-items-center">
					<a href="{{ route('customers') }}" class="bj-btn-table-delete mt-5 form-control-sm"> VOLVER A LA TABLA GENERAL</a>
				</div>
			</div>
				...
				<div class="card-footer">
					<div class="row">
						<div class="col-md-12 text-center">
							<button type="submit" class="bj-btn-table-add form-control-sm">REGISTRAR CLIENTE</button>
						</div>
					</div>
				</div>
			</form>

...
@section('customersComercial')
	<div class="col-md-12">
		<div class="row text-center my-2">
			...
			<div class="col-md-6">
				<a href="{{ route('customer.new') }}" class="bj-btn-table-add mx-5 my-2 form-control-sm">REGISTRAR CLIENTE</a>
			</div>
		</div>
				...
				@foreach($customers as $customer)
					<tr>
						...
						<td class="column-actions">
							...
							<a href="#" title="DETALLES/ACCION DE CITACION" class="bj-btn-table-add rescheduling-link">
							...
							<!-- <a href="{{ route('customer.edit', $customer->cusId) }}" title="EDITAR" class="bj-btn-table-edit"><i class="fas fa-edit"></i></a>
							<a href="{{ route('customer.delete', $customer->cusId) }}" title="ELIMINAR" class="bj-btn-table-delete" onclick="return confirm('- Se eliminará el cliente, tenga en cuenta que se eliminarán los agendamientos PENDIENTES que tenga el cliente, ¿Desea eliminar el cliente?')"><i class="fas fa-trash-alt"></i></a> -->
						</td>
					</tr>
				@endforeach
			</tbody>
	        ...
	        <div class="row p-3 m-3">
	        	...
	        	<div class="col-md-4">
	        		<form id="form-sendMail" action="{{ route('customer.remember') }}" style="margin-left: 20px; visibility: hidden;">
		        		...
		        		<button type="submit" class="bj-btn-table-edit form-control-sm">ENVIAR CORREO <i class="fas fa-envelope-open-text"></i></button>
		        	</form>
	        	</div>
	      			...
	      			<div class="row">
	      				<div class="col-md-6">
			      			...
			      			<form action="{{ route('scheduling.change') }}" method="POST" autocomplete="off">
			      				...
			      				<div class="row">
			      					<div class="col-md-12 text-center">
			      						<button type="submit" class="bj-btn-table-edit m-2">CAMBIAR</button>
			      					</div>
			      				</div>
			      			</form>
			      			<div class="row p-3 border-top border-bottom" style="background: #ccc;">
			      			...
			      			<form action="{{ route('scheduling.reprogramming') }}" method="POST" autocomplete="off">
			      				...
			      				<div class="row">
			      					<div class="col-md-12 text-center">
			      						<button type="submit" class="bj-btn-table-add">REPROGRAMAR</button>
...
@section('scripts')
	<script>
		...
		$('.rescheduling-link').on('click',function(e){
			...
			$.get("{{ route('getSchedulingForChange') }}",{cusId: cusId },function(objectScheduling){
			...
			$.get("{{ route('getHistoryVisits') }}",{cusId: cusId},function(objectHistory){
		...
		function getDateComplete(value){
			...
			switch(separated[1]){
				case '01': return separated[2] + ' de ENERO del ' + separated[0]; break;
				case '02': return separated[2] + ' de FEBRERO del ' + separated[0]; break;
				case '03': return separated[2] + ' de MARZO del ' + separated[0]; break;
				case '04': return separated[2] + ' de ABRIL del ' + separated[0]; break;
				case '05': return separated[2] + ' de MAYO del ' + separated[0]; break;
				case '06': return separated[2] + ' de JUNIO del ' + separated[0]; break;
				case '07': return separated[2] + ' de JULIO del ' + separated[0]; break;
				case '08': return separated[2] + ' de AGOSTO del ' + separated[0]; break;
				case '09': return separated[2] + ' de SEPTIEMBRE del ' + separated[0]; break;
				case '10': return separated[2] + ' de OCTUBRE del ' + separated[0]; break;
				case '11': return separated[2] + ' de NOVIEMBRE del ' + separated[0]; break;
				case '12': return separated[2] + ' de DICIEMBRE del ' + separated[0]; break;
			}
		}

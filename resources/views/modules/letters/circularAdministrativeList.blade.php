...
<div hidden>
    <form action="{{ route('circularadministrative.view') }}" method="POST" id="formCircular">
        @csrf
...
<div class="modal fade" id="ModalCircular" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('circularadministrative.delete') }}" id="deleteCircular" method="POST" hidden>
                @csrf
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger" onclick="formDel()">Eliminar</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function del(id) {
        ...
        $.get("{{route('getAdministrativeDel')}}", {
            data: id
        }, function(objectDel) {

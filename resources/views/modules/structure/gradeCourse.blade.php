	...
	<div class="col-md-12">
		<div class="row mb-3 border-bottom">
			<div class="col-md-6 form-inline">
				...
				<a href="{{ route('listgradeCourse') }}" class="bj-btn-table-edit mx-4 form-control-sm">VER LISTADOS</a>
			</div>
			<div class="col-md-6">
			...
			<div class="row">
				...
				<div class="col-md-4">
					...
					<div class="form-group text-center">
						<button type="submit" class="bj-btn-table-add form-control-sm mt-4">ESTABLECER GRUPO</button>
					</div>
				</div>
			</div>
		</form>
...
@section('scripts')
	<script>
		...
		$('select[name=ccCourse]').on('change',function(e){
			...
			if(selectedCourse != ''){
				$.get("{{ route('getCountStudent') }}",{selectedCourse: selectedCourse},function(objectCountCourses){

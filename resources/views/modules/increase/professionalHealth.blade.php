...
@section('logisticModules')
	<div class="col-md-12 p-3">
		<div class="row border-bottom mb-3">
			...
			<div class="col-md-4">
				<button type="button" title="NUEVO REGISTRO" class="bj-btn-table-add form-control-sm newProfessional-link">NUEVO REGISTRO</button>
			</div>
			<div class="col-md-4">
		...
		<table id="tableDatatable" class="table table-hover text-center" width="100%">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="#" title="EDITAR" class="bj-btn-table-edit editProfessionalhealth-link">
							<i class="fas fa-edit"></i>
							<span hidden>{{ $professional->phId }}</span>
							<span hidden>{{ $professional->phName }}</span>
						</a>
						<a href="#" title="ELIMINAR" class="bj-btn-table-delete deleteProfessionalhealth-link">

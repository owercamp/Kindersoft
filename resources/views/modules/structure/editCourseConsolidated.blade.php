...
@section('academicModules')
	<div class="col-md-12">
		<div class="row border-top">
			...
			<div class="col-md-6">
				<a href="{{ route('listgradeCourse') }}" class="bj-btn-table-delete my-4 form-control-sm">VOLVER</a>
			</div>
		</div>
				...
				<form action="{{ route('gradeCourse.update') }}" method="POST">
					...
					<div class="row">
						<div class="col-md-12 text-center">
							...
							<button type="submit" class="bj-btn-table-add form-control-sm mt-4">GUARDAR CAMBIOS</button>
						</div>
					</div>
				</form>
			</div>

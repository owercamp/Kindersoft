...
<script>
  $('.migrationForm-link').on('click', function(e) {
    ...
    $.get("{{ route('getLegalizationMigration') }}", {
      ...
      let DataAttendant1 = [/*** IDENTIFICACION */ objectMigration[1][2][1],/*** NOMBRES */ objectMigration[1][1][3],/*** DIRECCION */ objectMigration[1][3][1],/*** CIUDAD EMPRESA */ objectMigration[1][14][1],/*** LOCALIDAD */ objectMigration[1][5][1],/*** BARRIO */ objectMigration[1][4][1],/*** CELULAR */ objectMigration[1][6][1],/*** WHATSAPP */ objectMigration[1][7][1],/*** EMAIL */ objectMigration[1][8][1], 'INDEFINIDO',/*** CARGO */ objectMigration[1][17][1],/*** EMPRESA */ objectMigration[1][12][1],/*** CARGO */ objectMigration[1][17][1],/*** FECHA INGRESO */ objectMigration[1][18][1],/*** DIRECCION */ objectMigration[1][13][1],/*** CIUDAD EMPRESA */ objectMigration[1][14][1],/*** LOCALIDAD EMPRESA */ objectMigration[1][16][1],/*** BARRIO EMPRESA */ objectMigration[1][15][1], 'ACTIVO'];
      let DataAttendant2 = [/*** IDENTIFICACION */objectMigration[2][2][1],/*** NOMBRES */ objectMigration[2][1][3],/*** DIRECCION */ objectMigration[2][3][1],/*** CIUDAD EMPRESA */ objectMigration[2][14][1],/*** LOCALIDAD */ objectMigration[2][5][1],/*** BARRIO */ objectMigration[2][4][1],/*** CELULAR */ objectMigration[2][6][1],/*** WHATSAPP */ objectMigration[2][7][1],/*** EMAIL */ objectMigration[2][8][1], 'INDEFINIDO',/*** CARGO */ objectMigration[2][17][1],/*** EMPRESA */ objectMigration[2][12][1],/*** CARGO */ objectMigration[2][17][1],/*** FECHA INGRESO */ objectMigration[2][18][1],/*** DIRECCION */ objectMigration[2][13][1],/*** CIUDAD EMPRESA */ objectMigration[2][14][1],/*** LOCALIDAD EMPRESA */ objectMigration[2][16][1],/*** BARRIO EMPRESA */ objectMigration[2][15][1], 'ACTIVO'];
      if (count > 0) {

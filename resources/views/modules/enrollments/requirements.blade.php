			...
			<tbody>
				@foreach($documentsEnrollment as $document)
					<tr>
						...
						<td>
							<a href="#" title="EDITAR" class="bj-btn-table-edit updateDocumentEnrollment-link">
							...
							<a href="#" title="ELIMINAR" class="bj-btn-table-delete deleteDocumentEnrollment-link">
				...
				@endforeach
					<tfoot class="row">
						<div class="col-md-12 text-center">
							<button id="addDocumentEnrollment" type="button" class="bj-btn-table-add form-control-sm">AGREGAR REQUISITO</button>
						</div>
					</tfoot>
			</tbody>
		</table>
					...
					<div class="modal-body">
						<form id="formNewDocumentEnrollment" action="{{ route('newDocumentEnrollment') }}" method="POST">
							...
							<div class="form-group text-center">
								<button type="submit" class="bj-btn-table-add form-control-sm">AÑADIR A LA LISTA</button>
							</div>
						</form>
					</div>
				</div>
				...
				<form action="{{ route('deleteDocumentEnrollment') }}" method="POST">
					...
					<div class="modal-content">
						...
						<div class="modal-footer text-center">
							<button type="submit" class="bj-btn-table-edit mx-3 form-control-sm">CONTINUAR</button>
							<button type="button" class="bj-btn-table-delete mx-3 form-control-sm" data-dismiss="modal">CANCELAR</button>
						</div>
					</div>
				</form>
			</div>
				...
				<form id="formUpdateDocumentEnrollment" action="{{ route('updateDocumentEnrollment') }}" method="POST">
					...
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							<button type="button" class="bj-btn-table-delete float-right form-control-sm" data-dismiss="modal">CANCELAR</button>
						</div>
					</div>
				</form>
			</div>
...
@section('scripts')
	<script>
		...
		$('select[name=dePositionNew]').on('change',function(e){
			var selected = e.target.value;
			if(selected != ''){
				$.get("{{ route('getNumberSelected') }}",{ number: selected },function(number){

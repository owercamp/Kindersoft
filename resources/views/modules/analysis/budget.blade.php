...
<div class="col-md-12">
  <div class="row mt-5">
    ...
    <div class="col-md-4">
      <button type="button" class="btn btn-outline-success form-control-sm newBudget-link">NUEVO PRESUPUESTO</button>
    </div>
  </div>
  <table id="tableDatatable" class="table table-hover text-center" width="100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>{{ $annual->aValue }}</td>
        <td>
          <button type="button" class="btn btn-outline-primary rounded-circle form-control-sm editBudget-link" title="EDITAR">
          ...
          <button type="button" class="btn btn-outline-tertiary rounded-circle  form-control-sm deleteBudget-link" title="ELIMINAR">
          ...
          <div class="row">
            <div class="col-md-12 text-center">
              <div class="form-group text-center">
                <button type="submit" class="btn btn-outline-success form-control-sm btn-saveAnnual">GUARDAR PRESUPUESTO</button>
              </div>
            </div>
          </div>
        </form>
          ...
          <div class="row">
            <div class="col-md-12 text-right">
              <div class="form-group text-right">
                ...
                <button type="submit" class="btn btn-outline-success form-control-sm btn-updateAnnual">GUARDAR CAMBIOS DE PRESUPUESTO</button>
              </div>
            </div>
          </div>
        </form>
        ...
        <div class="row border-top p-3">
          <div class="col-md-12 text-center">
            <form action="{{ route('budget.delete') }}" method="POST">
              ...
              <button type="submit" class="btn btn-outline-success form-control-sm btn-updateAnnual">ELIMINAR PRESUPUESTO</button>
            </form>
          </div>
        </div>
      </div>
...
<script>
  ...
  $('.editBudget-link').on('click', function() {
    ...
    for (var i = 0; i < separatedDetails.length; i++) {
      ...
      if (i == 0) {
        $('input[name=january_edit]').val(separatedValues[1]);
      } else if (i == 1) {
        $('input[name=february_edit]').val(separatedValues[1]);
      } else if (i == 2) {
        $('input[name=march_edit]').val(separatedValues[1]);
      } else if (i == 3) {
        $('input[name=april_edit]').val(separatedValues[1]);
      } else if (i == 4) {
        $('input[name=may_edit]').val(separatedValues[1]);
      } else if (i == 5) {
        $('input[name=june_edit]').val(separatedValues[1]);
      } else if (i == 6) {
        $('input[name=july_edit]').val(separatedValues[1]);
      } else if (i == 7) {
        $('input[name=august_edit]').val(separatedValues[1]);
      } else if (i == 8) {
        $('input[name=september_edit]').val(separatedValues[1]);
      } else if (i == 9) {
        $('input[name=october_edit]').val(separatedValues[1]);
      } else if (i == 10) {
        $('input[name=november_edit]').val(separatedValues[1]);
      } else if (i == 11) {
        $('input[name=december_edit]').val(separatedValues[1]);
      }
    }
  ...
  $('.deleteBudget-link').on('click', function() {
    ...
    for (var i = 0; i < separatedDetails.length; i++) {
      var separatedValues = separatedDetails[i].split(':');
      if (i == 0) {
        $('.january_details').text('ENERO: ' + separatedValues[1]);
      } else if (i == 1) {
        $('.february_details').text('FEBRERO: ' + separatedValues[1]);
      } else if (i == 2) {
        $('.march_details').text('MARZO: ' + separatedValues[1]);
      } else if (i == 3) {
        $('.april_details').text('ABRIL: ' + separatedValues[1]);
      } else if (i == 4) {
        $('.may_details').text('MAYO: ' + separatedValues[1]);
      } else if (i == 5) {
        $('.june_details').text('JUNIO: ' + separatedValues[1]);
      } else if (i == 6) {
        $('.july_details').text('JULIO: ' + separatedValues[1]);
      } else if (i == 7) {
        $('.august_details').text('AGOSTO: ' + separatedValues[1]);
      } else if (i == 8) {
        $('.september_details').text('SEPTIEMBRE: ' + separatedValues[1]);
      } else if (i == 9) {
        $('.october_details').text('OCTUBRE: ' + separatedValues[1]);
      } else if (i == 10) {
        $('.november_details').text('NOVIEMBRE: ' + separatedValues[1]);
      } else if (i == 11) {
        $('.december_details').text('DICIEMBRE: ' + separatedValues[1]);
      }
    }

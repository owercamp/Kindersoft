			...
			<div class="col-md-6">
				...
				<form action="{{ route('achievement.importExcel') }}" method="POST" enctype="multipart/form-data" style="display: none;">
					...
					<div class="form-group">
						...
						<button type="submit" class="bj-btn-table-add form-control-sm">IMPORTAR DE EXCEL</button>
					</div>
				</form>
			</div>
		</div>
			...
			<tbody>
				...
				@foreach($achievements as $achievement)
					<tr>
						...
						<td><a href="{{ route('achievement.edit', $achievement->id) }}" title="EDITAR" class="bj-btn-table-edit"><i class="fas fa-edit"></i></a></td>
						<td><a href="{{ route('achievement.delete', $achievement->id) }}" title="ELIMINAR" class="bj-btn-table-delete" onclick="return confirm('¿Desea borrar el logro?')"><i class="fas fa-trash-alt"></i></a></td>
					</tr>
				@endforeach
			</tbody>
		</table>

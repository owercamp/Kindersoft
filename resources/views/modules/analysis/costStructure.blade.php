...
@section('financialModules')
	<div class="col-md-12">
		<div class="row mt-5">
			...
			<div class="col-md-6">
				<a href="#" class="bj-btn-table-add form-control-sm newCoststructure-link">NUEVA ESTRUCTURA</a>
			</div>
		</div>
			...
			<tbody>
				...
				@foreach($structure as $cost)
					<tr>
						...
						<td>
							<a href="#" class="bj-btn-table-edit editCoststructure-link" title="EDITAR">
								<i class="fas fa-edit"></i>
								<span hidden>{{ $cost->csId }}</span>
								<span hidden>{{ $cost->csDescription }}</span>
							</a>
							<a href="#" class="bj-btn-table-delete deleteCoststructure-link" title="ELIMINAR">
				...
				<div class="modal-body p-4">
					...
					<form action="{{ route('analysis.deleteCoststructure') }}" method="POST">
						...
						<div class="form-group text-center">
							<button type="submit" class="bj-btn-table-add m-4">SI, ELIMINAR</button>
						</div>
					</form>
				</div>
			</div>

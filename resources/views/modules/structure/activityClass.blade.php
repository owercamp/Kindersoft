	...
	<div class="col-md-12">
		<div class="row border-bottom mb-3">
			<div class="col-md-6">
				...
				<a href="#" title="AGREGAR" class="bj-btn-table-add form-control-sm newActivityClass-link">AGREGAR CLASE/ACTIVIDAD</a>
			</div>
			<div class="col-md-6">
		...
		<table id="tableactivityclass" class="table table-hover text-center">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="#" title="EDITAR" class="bj-btn-table-edit editActivityClass-link">
						...
						<a href="#" title="ELIMINAR" class="bj-btn-table-delete deleteActivityClass-link">

...
@section('humans')
	<div class="col-md-12">
		<div class="row text-center my-2">
			...
			<div class="col-md-6">
				<a href="{{ route('provider.new') }}" class="bj-btn-table-add mx-5 my-2 form-control-sm">REGISTRAR PROVEEDOR</a>
			</div>
		</div>
				...
				@foreach($providers as $provider)
					<tr>
						...
						<td class="d-flex justify-content-between">
							<a href="{{ route('provider.details', $provider->id) }}" title="VER DETALLES" class="bj-btn-table-add"><i class="fas fa-eye"></i></a>
							<a href="{{ route('provider.edit', $provider->id) }}" title="EDITAR" class="bj-btn-table-edit"><i class="fas fa-edit"></i></a>
							<a href="{{ route('provider.delete', $provider->id) }}" title="ELIMINAR" class="bj-btn-table-delete" onclick="return confirm('* Se eliminará el proveedor')"><i class="fas fa-trash-alt"></i></a>
						</td>
					</tr>
				@endforeach
			</tbody>

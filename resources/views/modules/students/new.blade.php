...
<div class="row card">
	<div class="card-header">
		<div class="row text-center">
			...
			<div class="col-md-6">
				<a href="{{ route('students') }}" class="bj-btn-table-delete form-control-sm">VOLVER</a>
			</div>
		</div>
	</div>
		...
		<div class="card-footer">
			<div class="row">
				<div class="col-md-6 text-center">
					<button type="submit" class="bj-btn-table-add form-control-sm">GUARDAR ESTUDIANTE</button>
				</div>
				<div class="col-md-6 text-center">

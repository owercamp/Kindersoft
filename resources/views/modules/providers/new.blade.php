...
<div class="row card">
	<div class="card-header">
		<div class="row text-center">
			...
			<div class="col-md-6">
				<a href="{{ route('providers') }}" class="bj-btn-table-delete form-control-sm">VOLVER</a>
			</div>
		</div>
	</div>
			...
			<div class="row">
				<div class="col-md-6 border-right">
					<div class="form-group">
						...
						<select class="form-control form-control-sm" name="typedocument_id" id="typedocument_id" required value="{{ old('typedocument_id') }}">
		...
		<div class="card-footer">
			<div class="row">
				<div class="col-md-6 text-center">
					<button type="submit" class="bj-btn-table-add form-control-sm">GUARDAR PROVEEDOR</button>
				</div>
				<div class="col-md-6 text-center">

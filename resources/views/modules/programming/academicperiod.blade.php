	...
	<div class="col-md-12">
		<div class="row mb-3 border-bottom py-3">
			<div class="col-md-6">
				...
				<a href="{{ route('academicperiod.new') }}" class="bj-btn-table-delete form-control-sm">REGISTRAR PERIODOS</a>
			</div>
			<div class="col-md-6">
			...
			<tbody>
				@foreach($academicperiods as $academicperiod)
					<tr>
						...
						<td>
							<a href="#" class="bj-btn-table-edit editAcademicperiod-link" title="EDITAR">
							...
							<a href="#" class="bj-btn-table-delete deleteAcademicperiod-link" title="ELIMINAR">
		    	...
		    	<div class="modal-body">
		    		<form action="{{ route('academicperiod.delete') }}" method="POST">
			    		...
			    		<div class="form-group">
			    			...
			    			<button type="submit" class="bj-btn-table-edit float-left form-control-sm">ELIMINAR</button>
			    			<button type="button" class="bj-btn-table-delete float-right form-control-sm" data-dismiss="modal">CERRAR</button>
			    		</div>
		    		</form>
		    	</div>

		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<table id="tableList" class="table table-hover text-center" width="100%" style="font-size: 10px;">
						<thead>
							<tr>
								<th>ALUMNO</th>
								<th>JORNADA</th>
				...
				<div class="modal-footer text-center">
					...
					<div class="row assistanceNotAll" style="display: none;">
						<div class="col-md-12">
							...
							<table id="table-validate" class="table table-hover text-center" width="100%" style="font-size: 10px;">
								<thead>
									<tr>
										<th>NOMBRES</th>
	...
	<script>
		...
		function getAssistancesFilter(date){
			if(date != ''){
				...
				$.get("{{ route('assistances.get') }}",{dateSelected: date},function(objectAssistances){
		...
		$('#tableDatatable').on('click','.btn-edit',function(e){
			...
			if(assId != ''){
				...
				$.get("{{ route('getAssistancesForedit') }}",{ assId: assId }, function(objectAssistance){

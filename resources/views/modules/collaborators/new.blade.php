	...
	<div class="row card">
		<div class="card-header">
			<div class="row text-center">
				...
				<div class="col-md-6">
					<a href="{{ route('collaborators') }}" class="bj-btn-table-delete form-control-sm">VOLVER</a>
				</div>
			</div>
		</div>
				...
				<div class="row">
					<div class="col-md-6 border-right">
						<div class="form-group">
							<div class="row">
								<div class="col-md-6">
									...
									<select class="form-control form-control-sm" name="typedocument_id" required>
						...
						<div class="form-group">
							<div class="row">
								<div class="col-md-6">
									...
									<select class="form-control form-control-sm" name="bloodtype_id" required>
						...
						<div class="form-group">
							...
							<select class="form-control form-control-sm" name="profession_id" required>
					...
					<div class="col-md-6 border-left">
						<div class="form-group">
							...
							<select class="form-control form-control-sm" id="cityhome_id" name="cityhome_id" required>
						...
						<div class="form-group">
							<div class="row">
								<div class="col-md-6">
									...
									<select class="form-control form-control-sm" id="locationhome_id" name="locationhome_id" required>
								...
								<div class="col-md-6">
									...
									<select class="form-control form-control-sm" id="dictricthome_id" name="dictricthome_id" required>
			...
			<div class="card-footer">
				<div class="row">
					<div class="col-md-12 text-center">
						<button type="submit" id="saveCollaborator" class="bj-btn-table-add form-control-sm">GUARDAR COLABORADOR</button>
					</div>
				</div>
	...
	<script>
		$(document).ready(function(){
			...
			$("#locationhome_id").on("change", function(e){
				...
				$.get("{{ route('edit.subdistrict') }}", {locationhome_id: locationhome_id}, function(districtObject){

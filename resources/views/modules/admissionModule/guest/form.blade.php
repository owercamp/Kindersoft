  ...
  <main class="container" style="border: 1px solid #ccc; border-top: none; border-bottom: none;">
    ...
    <div class="row">
      <div class="col-md-12 d-flex flex-column justify-content-center align-items-center">
        <button type="button" class="btn btn-info text-center btn-block btn-again">VOLVER AL FORMULARIO</button>
        <br>
    ...
    <div class="row">
      <div class="col-md-12 d-flex flex-column justify-content-center align-items-center">
        <button type="button" class="btn btn-info text-center btn-block btn-again">VOLVER A INTENTARLO</button>
        <hr>
        @if(file_exists('storage/garden/logo.png'))

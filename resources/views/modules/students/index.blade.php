...
@section('humans')
	<div class="col-md-12">
		<div class="row text-center my-2">
			...
			<div class="col-md-6">
				<a href="{{ route('student.new') }}" class="bj-btn-table-add mx-5 my-2 form-control-sm">REGISTRAR ALUMNO</a>
			</div>
		</div>
					...
					@if ($student->status == "ACTIVO")
						<tr>
							...
							<td class="d-flex justify-content-between">
								<a href="{{ route('student.details', $student->id) }}" title="VER DETALLES" class="bj-btn-table-add"><i class="fas fa-eye"></i></a>
								<a href="{{ route('student.edit', $student->id) }}" title="EDITAR" class="bj-btn-table-edit"><i class="fas fa-edit"></i></a>
								<a href="{{route('student.active', $student->id)}}" title="ACTIVO" class="bj-btn-table-add"><i class="fa fa-check-circle"></i></a>
								<!--<a href="{{ route('student.delete', $student->id) }}" title="ELIMINAR" class="bj-btn-table-delete" onclick="return confirm('* Se eliminará el alumno con los registros relacionados')"><i class="fas fa-trash-alt"></i></a>-->
							</td>	
						</tr>
					@else
						<tr>
							...
							<td class="d-flex justify-content-between">
								<a href="{{ route('student.details', $student->id) }}" title="VER DETALLES" class="bj-btn-table-add"><i class="fas fa-eye"></i></a>
								<a href="{{ route('student.edit', $student->id) }}" title="EDITAR" class="bj-btn-table-edit"><i class="fas fa-edit"></i></a>
								<a href="{{route('student.inactive', $student->id)}}" title="INACTIVO" class="bj-btn-table-cancel"><i class="fa fa-ban"></i></a>
								<!--<a href="{{ route('student.delete', $student->id) }}" title="ELIMINAR" class="bj-btn-table-delete" onclick="return confirm('* Se eliminará el alumno con los registros relacionados')"><i class="fas fa-trash-alt"></i></a>-->
							</td>	
						</tr>
					@endif

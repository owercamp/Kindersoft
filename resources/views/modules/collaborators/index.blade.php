...
<div class="col-md-12">
  <div class="row text-center my-2">
    ...
    <div class="col-md-6">
      <a href="{{ route('collaborator.new') }}" class="btn btn-outline-success mx-5 my-2 form-control-sm">REGISTRAR COLABORADOR</a>
    </div>
  </div>
  <table id="tablecollaborators" class="table table-hover text-center">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="{{ route('collaborator.details', $collaborator->id) }}" title="VER DETALLES" class="btn btn-outline-success rounded-circle"><i class="fas fa-eye"></i></a><a href="{{ route('collaborator.edit', $collaborator->id) }}" title="EDITAR" class="btn btn-outline-primary rounded-circle"><i class="fas fa-edit"></i></a><a href="{{ route('collaborator.delete', $collaborator->id) }}" title="ELIMINAR" class="btn btn-outline-tertiary rounded-circle " onclick="return confirm('* Se eliminará el colaborador')"><i class="fas fa-trash-alt"></i></a></td>
      </tr>
      @endforeach
    </tbody>
  </table>

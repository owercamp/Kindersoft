		...
		<div class="row p-3 border-bottom">
			...
			<div class="col-md-6 pt-4">
				<div class="form-group form-inline">
					<button type="button" class="bj-btn-table-add form-control-sm btn-seeDates">CONSULTAR</button>
				</div>
			</div>
		</div>
		...
		<div class="row border p-4 sectionResult" style="display: none;">
			<div class="col-md-12 p-4 text-center">
				...
				<form action="{{ route('reportDaily.pdf') }}" method="GET">
					...
					<button type="submit" class="bj-btn-table-delete form-control-sm">DESCARGAR PDF</button>
				</form>
	...
	<script>
		...
		$('.btn-seeDates').on('click',function(){
			...
			if(dateSelected != ''){
				...
				$.get("{{ route('getReportDaily') }}",{ dateSelected: dateSelected },function(objectReport){

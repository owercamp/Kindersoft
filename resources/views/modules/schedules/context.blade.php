      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="d-flex justify-content-center">
            <a title="EDITAR" class="btn btn-outline-primary rounded-circle edit-hi" data-toggle="modal" data-target="#formEdit" style="margin-right: 5px"><i class="fas fa-edit"></i><span hidden>{{$item->sch_id}}</span>
              <span hidden>{{$item->sch_body}}</span></a>
            <a title="ELIMINAR" class="btn btn-outline-tertiary rounded-circle  delete-hi" data-toggle="modal" data-target="#formDelete" style="margin-left: 5px"><i class="fas fa-trash-alt"></i><span hidden>{{$item->sch_id}}</span>
              <span hidden>{{$item->sch_body}}</span></a>
          </td>
        </tr>
        @endforeach

          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" name="venDateInitial" class="form-control form-control-sm datepicker" required>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <small class="text-muted">FECHA FINAL:</small>
                <input type="text" name="venDateFinal" class="form-control form-control-sm datepicker" value="{{ $day }}" required>
              </div>
            </div>
            <div class="col-md-4">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="row modal-body">
        ...
        <div class="col-md-5">
          <table class="table table-concepts" width="100%">
            <thead>
              <tr>
                <th>CONCEPTO</th>
                <th>VALOR</th>
        ...
        <div class="col-md-3">
          ...
          <div class="input-group">
            ...
            <input type="text" class="form-control form-control-sm text-center" title="CÓDIGO DE COMPROBANTE" name="codeVoucher" style="font-weight: bold;" disabled>
          </div>
          ...
          <div class="input-group">
            ...
            <input type="text" class="form-control form-control-sm text-center" title="CÓDIGO DE FACTURA" name="codeFacture" style="font-weight: bold;" disabled>
          </div>
        ...
        <form action="">
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-group">
                <small>FECHA:</small>
                <input type="text" class="form-control form-control-sm datepicker" value='{{ $day }}' required>
              </div>
            </div>
          </div>
          <div class="row">
      ...
      if (count > 0) {
        ...
        for (var i = 0; i < count; i++) {
          if (objectsEntry[i][0] == 'INFORMACION') {
            ...
            $('.valuePaid').text('');
            $('.valuePaid').text(objectsEntry[i][23]);
            $('.porcentageIva').text('');
            ...
            $('.valueFacture').text('');
            $('.valueFacture').text(objectsEntry[i][22]);
          } else {
            $('.table-concepts tbody').append('<tr><td>' + objectsEntry[i][1] + '</td><td>' + objectsEntry[i][2] + '</td><td>' + objectsEntry[i][3] + '</td></tr>');
          }
        }
      } else {
        //ALUMNO

			...
			<tbody>
				...
				@foreach($supplies as $supplie)
					<tr>
						...
						<td>
							<a href="{{ route('supplie.edit',$supplie->id) }}" title="EDITAR" class="bj-btn-table-edit"><i class="fas fa-edit"></i></a>
							<!--<a href="{{ route('supplie.delete',$supplie->id) }}" title="EDITAR" class="bj-btn-table-delete edit-city" onclick="return confirm('¿Desea eliminar el concepto de material escolar y los registros relacionados?')"><i class="fas fa-trash-alt"></i></a>-->
						</td>
					</tr>
				@endforeach
			</tbody>

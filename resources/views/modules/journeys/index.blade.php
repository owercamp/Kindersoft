...
<div class="col-md-12">
  <div class="row text-center border-bottom mb-4">
    ...
    <div class="col-md-6">
      <a href="{{ route('journey.new') }}" class="btn btn-outline-success mx-5 my-2 form-control-sm">REGISTRAR JORNADA</a>
    </div>
  </div>
  <table id="tablejourneys" class="table table-hover text-center" width="100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="{{ route('journey.edit',$journey->id) }}" title="EDITAR" class="btn btn-outline-primary rounded-circle"><i class="fas fa-edit"></i></a>
          <!--<a href="{{ route('journey.delete',$journey->id) }}" title="EDITAR" class="btn btn-outline-tertiary " onclick="return confirm('¿Desea eliminar la jornada con los registros relacionados?')"><i class="fas fa-trash-alt"></i></a>-->
        </td>
      </tr>
      @endforeach
    </tbody>

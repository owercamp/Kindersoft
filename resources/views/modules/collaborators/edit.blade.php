			...
			<div class="card-footer">
				<div class="row">
					<div class="col-md-6 text-center">
						<button type="submit" id="saveCollaborator" class="bj-btn-table-edit form-control-sm">GUARDAR CAMBIOS</button>
					</div>
					<div class="col-md-6 text-center">
	...
	<script>
		...
		function fullSelectLocation(value){
			$.get("{{ route('edit.sublocation') }}", {cityhome_id: value}, function(locationObject){
				...
				$.get("{{ route('edit.subdistrict') }}", {locationhome_id: locationhome_id_result}, function(districtObject){
					var count = Object.keys(districtObject).length //total de barrios devueltos
					$('#dictricthome_id_edit').empty();
					$('#dictricthome_id_edit').append("<option value=''>Seleccione barrio...</option>");

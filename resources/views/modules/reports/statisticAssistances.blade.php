...
@section('logisticModules')
	<div class="col-md-12">
		...
		<div class="row border-bottom p-3 text-center">
			<div class="col-md-12">
				<a href="#" class="bj-btn-table-add btn-executeStatistic">CONSULTAR</a>
			</div>
		</div>
		...
		<div class="row border-top text-center pt-3 report" style="display: none;">
			<div class="col-md-12">
				<div class="row text-center">
					<div class="col-md-12">
						<b><h6 class="nameStudent-title"></h6></b>
					</div>
				</div>
				<div class="row">
					<div class="col-md-6 text-center">
						...
						<a href="#" class="btnDownload bj-btn-table-delete text-center"><i class="fas fa-file-pdf"></i> PDF</a>
					</div>
		...
		$('select[name=saCourse]').on('change',function(e){
			...
			if(courseSelected != ''){
				$.get("{{ route('getStudentFromCourse') }}",{courseSelected: courseSelected},function(objectStudents){
					...
					$.get("{{ route('getPeriodsOfCourse') }}",{courseSelected: courseSelected},function(objectPeriods){
		...
		$('.btn-executeStatistic').on('click',function(e){
			...
			if(courseSelected != '' && courseSelected != null &&
				...
				$.ajax({
					...
					data: {course: courseSelected, period: periodSelected, student: studentSelected},
					dataType: 'json',
					async: false,
					beforeSend: function(){

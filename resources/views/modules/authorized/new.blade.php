...
@section('humans')
	...
	<div class="card-header">
		<div class="row text-center">
			...
			<div class="col-md-6">
				<a href="{{ route('authorized') }}" class="bj-btn-table-delete form-control-sm">VOLVER</a>
			</div>
		</div>
	</div>
		...
		<div class="card-footer">
			<div class="row">
				<div class="col-md-12 text-center">
					<button id="saveAuthorized" type="submit" class="bj-btn-table-add form-control-sm">GUARDAR AUTORIZADO</button>
				</div>
			</div>
		</div>
	</form>

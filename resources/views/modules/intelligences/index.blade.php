			...
			<div class="col-md-6">
				<form action="{{ route('intelligence.new') }}" method="PUT">
					...
					<div class="row justify-content-center">
						<button type="submit" class="bj-btn-table-add mb-2 form-control-sm">CREAR</button>
					</div>
				</form>
			</div>
			<div class="col-md-6">
			...
			<tbody>
				...
				@foreach($intelligences as $intelligence)
					<tr>
						...
						<td><a href="{{ route('intelligence.edit', $intelligence->id) }}" title="EDITAR" class="bj-btn-table-edit"><i class="fas fa-edit"></i></a></td>
						<td><a href="{{ route('intelligence.delete', $intelligence->id) }}" title="ELIMINAR" class="bj-btn-table-delete" onclick="return confirm('Si borra esta inteligencia, tambien se eliminarán los logros asociados. ¿Desea borrar la inteligencia con sus logros?')"><i class="fas fa-trash-alt"></i></a></td>
					</tr>
				@endforeach
			</tbody>
			<tfoot>

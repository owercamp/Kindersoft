								...
								<div class="col-md-6 border-right">
									...
									<div class="row">
										...
										<div class="col-md-4 pt-3 text-center">
											<button type="button" class="btn-add addAdmission bj-btn-table-edit" style="width: 50px; line-height: 30px;" title="AÑADIR"><i class="fas fa-arrow-alt-circle-right"></i></button>
										</div>
									</div>
									<div class="row">
										<div class="col-md-8">
										...
										<div class="col-md-4 pt-3 text-center">
											<button type="button" class="btn-add addJourney bj-btn-table-edit" style="width: 50px; line-height: 30px;" title="AÑADIR"><i class="fas fa-arrow-alt-circle-right"></i></button>
										</div>
									</div>
									<div class="row">
										<div class="col-md-8">
										...
										<div class="col-md-4 pt-3 text-center">
											<button type="button" class="btn-add addFeeding bj-btn-table-edit" style="width: 50px; line-height: 30px;" title="AÑADIR"><i class="fas fa-arrow-alt-circle-right"></i></button>
										</div>
									</div>
									<div class="row">
										<div class="col-md-8">
										...
										<div class="col-md-4 pt-3 text-center">
											<button type="button" class="btn-add addUniform bj-btn-table-edit" style="width: 50px; line-height: 30px;" title="AÑADIR"><i class="fas fa-arrow-alt-circle-right"></i></button>
										</div>
									</div>
									<div class="row">
										<div class="col-md-8">
										...
										<div class="col-md-4 pt-3 text-center">
											<button type="button" class="btn-add addSupplie bj-btn-table-edit" style="width: 50px; line-height: 30px;" title="AÑADIR"><i class="fas fa-arrow-alt-circle-right"></i></button>
										</div>
									</div>
									<div class="row">
										<div class="col-md-8">
										...
										<div class="col-md-4 pt-3 text-center">
											<button type="button" class="btn-add addTransport bj-btn-table-edit" style="width: 50px; line-height: 30px;" title="AÑADIR"><i class="fas fa-arrow-alt-circle-right"></i></button>
										</div>
									</div>
									<div class="row">
										<div class="col-md-8">
										...
										<div class="col-md-4 pt-3 text-center">
											<button type="button" class="btn-add addExtratime bj-btn-table-edit" style="width: 50px; line-height: 30px;" title="AÑADIR"><i class="fas fa-arrow-alt-circle-right"></i></button>
										</div>
									</div>
									<div class="row">
										<div class="col-md-8">
										...
										<div class="col-md-4 pt-3 text-center">
											<button type="button" class="btn-add addExtracurricular bj-btn-table-edit" style="width: 50px; line-height: 30px;" title="AÑADIR"><i class="fas fa-arrow-alt-circle-right"></i></button>
										</div>
									</div>
									<div class="form-group">
				...
				<div class="card-footer">
					<div class="row">
						<div class="col-md-12 text-center">
							...
							<button type="submit" class="bj-btn-table-add form-control-sm btn-send" style="display: none;">COTIZAR</button>
						</div>
					</div>
				</div>
			</form>
...
@section('scripts')
	<script>
		...
		$('#proCustomer_id').on('change',function(e){
			...
			$.get("{{ route('selectedCustomerForQuotation') }}", {customerSelected: customer_id}, function(customerObject){
				...
				$.get("{{ route('schedulingActiveFromCustomer') }}", {customerSelected: customer_id}, function(schedulingObject){
		...
		$('select[name=proGrade_id]').on('change',function(e){
			if(e.target.value !== ''){
				$.get("{{ route('selectedGradeQuotation') }}", {selectedConcept: e.target.value}, function(gradeObject){
					$('.conceptGrade').text('');
		...
		$('.addAdmission').on('click',function(){
			...
			if(admission !== ''){
				$.get("{{ route('selectedAdmissionQuotation') }}", {selectedConcept: admission}, function(admissionObject){
		...
		$('.addJourney').on('click',function(){
			...
			if(journey !== ''){
				$.get("{{ route('selectedJourneyQuotation') }}", {selectedConcept: journey}, function(journeyObject){
		...
		$('.addFeeding').on('click',function(){
			...
			if(feeding !== ''){
				$.get("{{ route('selectedFeedingQuotation') }}", {selectedConcept: feeding}, function(feedingObject){
		...
		$('.addUniform').on('click',function(){
			...
			if(uniform !== ''){
				$.get("{{ route('selectedUniformQuotation') }}", {selectedConcept: uniform}, function(uniformObject){
		...
		$('.addSupplie').on('click',function(){
			...
			if(supplie !== ''){
				$.get("{{ route('selectedSupplieQuotation') }}", {selectedConcept: supplie}, function(supplieObject){
		...
		$('.addTransport').on('click',function(){
			...
			if(transport !== ''){
				$.get("{{ route('selectedTransportQuotation') }}", {selectedConcept: transport}, function(transportObject){
		...
		$('.addExtratime').on('click',function(){
			...
			if(extratime !== ''){
				$.get("{{ route('selectedExtratimeQuotation') }}", {selectedConcept: extratime}, function(extratimeObject){
		...
		$('.addExtracurricular').on('click',function(){
			...
			if(extracurricular !== ''){
				$.get("{{ route('selectedExtracurricularQuotation') }}", {selectedConcept: extracurricular}, function(extracurricularObject){

...
<div class="col-md-12">
  <div class="row border-top">
    ...
    <div class="col-md-4">
      <a href="#" class="btn btn-outline-success my-4 form-control-sm traslateStudent-link" title="TRASLADE ALUMNOS EN LOS GRADOS EXISTENTES">TRASLADO ENTRE GRADOS</a>
      <a href="{{ route('gradeCourse') }}" class="btn btn-outline-tertiary  my-4 form-control-sm">VOLVER</a>
    </div>
  </div>
  <table id="tablelistcourses" class="table table-hover text-center" width="100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <h5 class="badge badge-info">{{ $counts[$index++] }}</h5>
        </td>
        ...
        <td>
          ...
          <form action="{{ route('gradeCourse.pdf') }}" method="GET" style="display: inline-block;">
            ...
            <button type="submit" title="DESCARGAR LISTADO" class="btn btn-outline-tertiary rounded-circle  form-control-sm">
          ...
          <form action="{{ route('gradeCourse.edit') }}" method="GET" style="display: inline-block;">
            @csrf
            <input type="hidden" name="ccId" value="{{ $group->ccId }}" class="form-control form-control-sm">
            <button type="submit" title="EDITAR" class="btn btn-outline-primary rounded-circle form-control-sm">
              <i class="fas fa-edit"></i>
            </button>
          </form>
          <button type="submit" title="CAMBIAR ALUMNOS" class="btn btn-outline-success rounded-circle form-control-sm changeStudent-link">
      ...
      <div class="modal-body">
        ...
        <div class="row p-2">
          ...
          <div class="col-md-2 d-flex flex-column justify-content-center">
            <button type="button" class="btn btn-outline-primary form-control-sm btn-add" title="AGREGAR ALUMNOS SELECCIONADOS">
              <i class="fas fa-chevron-right"></i>
              <i class="fas fa-chevron-right"></i>
              <i class="fas fa-chevron-right"></i>
            </button>
            <button type="button" class="btn btn-outline-tertiary  form-control-sm btn-remove" title="QUITAR ALUMNOS SELECCIONADOS">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            <button type="button" class="btn btn-outline-success form-control-sm btn-translate">TRASLADAR</button>
          </div>
        </div>
      </div>
    </div>

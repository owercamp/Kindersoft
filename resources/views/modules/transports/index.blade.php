			...
			<tbody>
				...
				@foreach($transports as $transport)
					<tr>
						...
						<td>
							<a href="{{ route('transport.edit',$transport->id) }}" title="EDITAR" class="bj-btn-table-edit"><i class="fas fa-edit"></i></a>
							<!--<a href="{{ route('transport.delete',$transport->id) }}" title="EDITAR" class="bj-btn-table-delete edit-city" onclick="return confirm('¿Desea eliminar el concepto de transporte y los registros relacionados?')"><i class="fas fa-trash-alt"></i></a>-->
						</td>
					</tr>
				@endforeach
			</tbody>

		...
		<div class="col-md-6">
			<form id="formPeriodNew" action="{{ route('period.new') }}" method="PUT">
				...
				<div class="row justify-content-center">
					<button type="submit" class="bj-btn-table-add form-control-sm">CREAR PERIODO</button>
				</div>
			</form>
		</div>
	...
	<table id="tableperiods" class="table table-hover text-center" style="width:100%;">
		...
		<tbody>
			...
			<tr>
				...
				<td><a href="{{ route('period.edit', $dates->id) }}" title="EDITAR" class="bj-btn-table-edit"><i class="fas fa-edit"></i></a></td>
				<td><a href="{{ route('period.delete', $dates->id) }}" title="ELIMINAR" class="bj-btn-table-delete" onclick="return confirm('¿Desea borrar el periodo?')"><i class="fas fa-trash-alt"></i></a></td>
			</tr>
			@endforeach
		</tbody>
	</table>

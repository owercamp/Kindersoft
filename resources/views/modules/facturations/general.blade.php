	...
	<div class="col-md-12">
		<div class="row my-3 border-bottom">
			...
			<div class="col-md-6">
				...
				@endif
				<div class="alert message-general"><!-- Mensajes --></div>
			</div>
		</div>
		<div class="row border-bottom pb-3">
			<form action="{{ route('general.save') }}" method="GET" class="col-md-6 border-right" autocomplete="off">
				...
				<div class="row text-center">
					<div class="col-md-12">
						@if(isset($general))
							<button type="submit" class="bj-btn-table-add">ACTUALIZAR INFORMACION GENERAL</button>
						@else
							<button type="submit" class="bj-btn-table-add">GUARDAR INFORMACION GENERAL</button>
						@endif
					</div>
				</div>
			</form>
				...
				<div class="row border-top border-bottom p-3">
					<form action="{{ route('general.numberinitial') }}" method="GET" class="col-md-12" autocomplete="off">
						...
						<div class="row text-center">
							<div class="col-md-12">
								@if(isset($numeration))
									<button type="submit" class="bj-btn-table-add">ACTUALIZAR NUMEROS INICIALES</button>
								@else
									<button type="submit" class="bj-btn-table-add">GUARDAR NUMEROS INICIALES</button>
								@endif
							</div>
						</div>
					</form>

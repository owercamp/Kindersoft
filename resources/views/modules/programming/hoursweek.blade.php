...
@section('academicModules')
	<div class="col-md-12">
		<div class="row p-4">
			...
			<div class="col-md-4">
				<button type="button" class="bj-btn-table-delete form-control-sm filterHourweek-link">FILTRAR DESCARGAS</button>
			</div>
			<div class="col-md-4">
		...
		<form action="" method="POST">
			...
			<div class="row">
				<div class="col-md-12 text-center">
					<div class="form-group">
						<button type="submit" class="bj-btn-table-add form-control-sm mt-4" style="display: none;">ESTABLECER HORARIO</button>
					</div>
				</div>
			</div>
		</form>
	  	...
	  	<div class="modal-dialog">
		    <div class="modal-content px-4 py-4">
		    	...
		    	<div class="modal-body">
		    		...
		    		<div class="form-group">
		    			<button id="confirmNewHour" type="button" class="bj-btn-table-add float-left form-control-sm">ACEPTAR</button>
		    ...
		    <div class="modal-content px-4 py-4">
		    	...
		    	<div class="modal-body">
		    		<form action="{{ route('hourweek.delete') }}" method="POST">
		    			...
		    			<button type="submit" class="bj-btn-table-delete float-left form-control-sm">ELIMINAR</button>
		    		</form>
		    		<button type="button" class="bj-btn-table-delete float-right form-control-sm" data-dismiss="modal">CERRAR</button>
		    	</div>
		    </div>
	...
	<div class="modal fade" id="filterHourweek-Modal">
	  	<div class="modal-dialog modal-lg">
		    <div class="modal-content px-4 py-4">
		    	<form action="{{ route('hourweek.pdf') }}" method="GET"> <!-- ROUTE PREV: hourweek.pdf -->
		    		@csrf
			    	<div class="modal-header row">
			    		<div class="col-md-12">
		    					...
		    					<div class="col-md-12">
		    						<div class="form-group dinamicSpace">
		    							...
		    							<div class="row">
		    								...
		    								<div class="col-md-4 text-center">
		    									<button type="button" class="bj-btn-table-add form-control-sm btn-filterSpace" style='display: none;'>CONSULTAR</button>
		    								</div>
		    							</div>
		    						</div>
		    						<div class="form-group dinamicActivity" style="display: none;">
		    							...
		    							<div class="row">
		    								...
		    								<div class="col-md-4 text-center">
		    									<button type="button" class="bj-btn-table-add form-control-sm btn-filterACtivity" style='display: none;'>CONSULTAR</button>
		    								</div>
		    							</div>
		    						</div>
		    						<div class="form-group dinamicCourse" style="display: none;">
		    							...
		    							<div class="row">
		    								...
		    								<div class="col-md-4 text-center">
		    									<button type="button" class="bj-btn-table-add form-control-sm btn-filterCourse" style='display: none;'>CONSULTAR</button>
		    								</div>
		    							</div>
		    						</div>
		    						<div class="form-group dinamicCollaborator" style="display: none;">
		    							...
		    							<div class="row">
		    								...
		    								<div class="col-md-4 text-center">
		    									<button type="button" class="bj-btn-table-add form-control-sm btn-filterCollaborator" style='display: none;'>CONSULTAR</button>
		    								</div>
		    							</div>
		    						</div>
		    						<div class="form-group dinamicHour" style="display: none;">
		    							...
		    							<div class="row">
		    								...
		    								<div class="col-md-4 text-center">
		    									<button type="button" class="bj-btn-table-add form-control-sm btn-filterHour" style="display: none;">CONSULTAR</button>
		    								</div>
		    							</div>
		    						</div>
		    						<div class="form-group dinamicDay" style="display: none;">
		    							...
		    							<div class="row">
		    								...
		    								<div class="col-md-4 text-center">
		    									<button type="button" class="bj-btn-table-add form-control-sm btn-filterDay" style="display: none;">CONSULTAR</button>
		    								</div>
		    							</div>
		    						</div>
		    					</div>
		...
		document.addEventListener('DOMContentLoaded', function() {
	        ...
	        var calendar = new FullCalendar.Calendar(calendarEl, {
				...
				eventClick: function(info){
					...
					$.get("{{ route('getDetailsHourweek') }}",{hwId: info.event.id},function(objectInfo){

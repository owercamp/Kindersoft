			...
			<tbody>
				...
				@foreach($bloodtypes as $bloodtype)
					<tr>
						...
						<td><a href="{{ route('bloodtype.delete', $bloodtype->id) }}" title="ELIMINAR" class="bj-btn-table-delete" onclick="return confirm('- Se borrará el grupo sanguineo')"><i class="fas fa-trash-alt"></i></a></td>
					</tr>
				@endforeach
			</tbody>
			<tfoot>

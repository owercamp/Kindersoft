...
@section('financialModules')
	<div class="col-md-12">
		<div class="row mt-5">
			...
			<div class="col-md-6">
				<a href="#" class="bj-btn-table-add form-control-sm newCostdescription-link">NUEVA DESCRIPCION</a>
			</div>
		</div>
			...
			<tbody>
				...
				@for($i = 0; $i < count($dates); $i++)
					<tr>
						...
						<td>{{ $dates[$i][3] }}</td>
						<td>
							<a href="#" class="bj-btn-table-edit editCostdescription-link" title="EDITAR">
							...
							<a href="#" class="bj-btn-table-delete deleteCostdescription-link" title="ELIMINAR">
				...
				<div class="modal-body p-4">
					<form action="{{ route('analysis.newCostdescription') }}" method="POST">
						...
						<div class="form-group text-center">
							<button type="submit" class="bj-btn-table-add m-4">CREAR DESCRIPCIÓN</button>
						</div>
					</form>
				</div>
			</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body p-4">
					<form action="{{ route('analysis.editCostdescription') }}" method="POST">
						...
						<div class="form-group text-center">
							<button type="submit" class="bj-btn-table-add m-4">GUARDAR CAMBIOS</button>
						</div>
					</form>
				</div>
			</div>
				...
				<div class="modal-body p-4 text-center">
					...
					<form action="{{ route('analysis.deleteCostdescription') }}" method="POST">
						...
						<div class="form-group">
							...
							<button type="submit" class="bj-btn-table-delete m-4">SI, ELIMINAR</button>
						</div>
					</form>
				</div>
			</div>

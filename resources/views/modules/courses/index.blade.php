			...
			<tbody>
				...
				@foreach($courses as $course)
					<tr>
						<td>{{ $i++ }}</td>
						<td>{{ $course->name }}</td>
						<td><a href="{{ route('course.edit', $course->id) }}" title="EDITAR" class="bj-btn-table-edit"><i class="fas fa-edit"></i></a></td>
						<td><a href="{{ route('course.delete', $course->id) }}" title="ELIMINAR" class="bj-btn-table-delete" onclick="return confirm('¿Desea borrar el curso?')"><i class="fas fa-trash-alt"></i></a></td>
					</tr>
				@endforeach
			</tbody>
			<tfoot>

...
<body>
  ...
  @endphp
  <img src="{{ asset('storage/garden/facturaanulada.png') }}" style="
        		width: 300px;
        		height: 300px;
        		position: absolute;
        		left: 50%;
  ...
  <table width="100%">
    <tr>
      <td colspan="2" style="text-align: center;">
        <h1 style="font-weight: bold; color: #ccc;">FACTURA</h1>
      </td>
  ...
  <table width="100%" style="border: 1px solid #ccc;">
    <tr>
      <td style="text-align: right; width: 80px;">
        <p class="titles" style="line-height: 15px; text-align: right;">
          <small class="text-muted titles" style="margin-top: 5px;">Cliente/s con {{ returnType($facture[1][3]) }}</small>
          <br>
          <br>
      ...
      <td style="text-align: left;">
        ...
        <p class="titles" style="line-height: 15px; text-align: left;">
          <small class="dates dates-green" style="margin-top: 5px;">{{ $facture[1][1] }}<br>{{ $facture[1][2] }}</small><br>
  ...
  <table width="100%" style="border: 1px solid #ccc; text-align: center;" cellpadding="2">
    ...
    @for($i = 2;$i < count($facture);$i++) <tr style="border: 1px solid #ccc;">
      ...
      @for($i = 1; $i <= $missingRow; $i++) <tr style="border: 1px solid #ccc;">
        ...
        <tr style="border: 1px solid #ccc;">
          <td rowspan="7" colspan="2" style="border: 1px solid #ccc; text-align: center;">
            ...
            <img src="{{ asset('storage/garden/logo.jpg') }}" style="width: 80px; height: auto;">
            @else
            <img src="{{ asset('storage/garden/default.png') }}" style="width: 80px; height: auto;">
            @endif
            @endif
          </td>

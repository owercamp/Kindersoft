...
@section('eventsModules')
	<div class="col-md-12 p-3">
		<div class="row border-bottom mb-3">
			...
			<div class="col-md-4">
				<button type="button" title="NUEVO REGISTRO" class="bj-btn-table-add form-control-sm newCreation-link">NUEVO REGISTRO</button>
			</div>
			<div class="col-md-4">
		...
		<table id="tableDatatable" class="table table-hover text-center" width="100%">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="#" title="EDITAR" class="bj-btn-table-edit editCreation-link">
							<i class="fas fa-edit"></i>
							<span hidden>{{ $creation->crId }}</span>
							<span hidden>{{ $creation->crName }}</span>
							<span hidden>{{ $creation->crDescription }}</span>
						</a>
						<a href="#" title="ELIMINAR" class="bj-btn-table-delete deleteCreation-link">

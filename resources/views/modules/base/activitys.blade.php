...
@section('academicModules')
	<div class="col-md-12 p-3">
		<div class="row border-bottom mb-3">
			...
			<div class="col-md-4">
				<button type="button" title="Registrar una base" class="bj-btn-table-add form-control-sm newBase-link">REGISTRAR BASE</button>
			</div>
			<div class="col-md-4">
		...
		<table id="tableDatatable" class="table table-hover text-center" width="100%">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="#" title="Editar base de actividad" class="bj-btn-table-edit form-control-sm editBase-link">
							<i class="fas fa-edit"></i>
							<span hidden>{{ $base->baId }}</span>
							<span hidden>{{ $base->baDescription }}</span>
							<span hidden>{{ $base->baIntelligence_id }}</span>
						</a>
						<a href="#" title="Eliminar base de actividad" class="bj-btn-table-delete form-control-sm deleteBase-link">

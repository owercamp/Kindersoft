...
<div class="col-md-12">
  <div class="row">
    ...
    <div class="col-md-4">
      <button type="button" class="btn btn-outline-tertiary  form-control-sm filterPlanning-link">ARCHIVOS DE CRONOGRAMA</button>
    </div>
    <div class="col-md-4">
  ...
  <form action="{{ route('planning.new') }}" method="POST">
        ...
        <div class="row sectionBases" style="display: none;">
          <div class="col-md-12">
            <div class="row p-2">
              ...
              <div class="col-md-6">
                <button type="button" class="btn btn-outline-primary form-control-sm btn-add" title="AGREGAR BASE DE ACTIVIDAD">
                  <i class="fas fa-plus-square"></i>
                </button>
                <button type="button" class="btn btn-outline-tertiary  form-control-sm btn-del" title="QUITAR BASE DE ACTIVIDAD">
    ...
    <div class="row sectionFinal" style="display: none;">
      <div class="col-md-12 text-center">
        ...
        <button type="submit" class="btn btn-outline-success form-control-sm btn-register">REGISTRAR CRONOGRAMA</button>
      </div>
    </div>
  </form>
</div>
  ...
  $('select[name=chIntelligence_id]').on('change', function(e) {
    if (e.target.value != '') {
      $.get("{{ route('getDescriptionIntelligence') }}", {
        intelligenceSelected: e.target.value
        ...
        $.get("{{ route('getBasesFromIntelligence') }}", {
          intelligenceSelected: e.target.value

				...
				<div class="row text-center">
					...
					<div class="col-md-6 p-3">
						<form action="{{ route('bulletins.pdf') }}" method="GET">
							...
							<button type="submit" class="bj-btn-table-delete form-control-sm">
	...
	<script>
		...
		$('select[name=pcPeriod]').on('change',function(e){
			...
			if(periodSelected != '' && studentSelected != ''){
				...
				$.get("{{ route('getObservationsBulletin') }}",{ periodSelected: periodSelected, studentSelected: studentSelected, courseSelected: courseSelected },function(objectObservations){

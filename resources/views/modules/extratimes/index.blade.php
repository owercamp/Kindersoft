  ...
  <table id="tableextratimes" class="table table-hover text-center" width="100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="{{ route('extratime.edit',$extratime->id) }}" title="EDITAR" class="btn btn-outline-primary rounded-circle"><i class="fas fa-edit"></i></a>
          <!--<a href="{{ route('extratime.delete',$extratime->id) }}" title="EDITAR" class="btn btn-outline-tertiary  edit-city" onclick="return confirm('¿Desea eliminar el concepto de tiempo extra y los registros relacionados?')"><i class="fas fa-trash-alt"></i></a>-->
        </td>
      </tr>
      @endforeach
    </tbody>

...
<div class="col-md-12 p-3">
  <div class="row border-bottom mb-3">
    ...
    <div class="col-md-4">
      <button type="button" title="NUEVO REGISTRO" class="btn btn-outline-success form-control-sm newRating-link">NUEVA VALORACION</button>
    </div>
    <div class="col-md-4">
      ...
      <tr>
        ...
        <td>
          <form action="{{ route('ratingPeriod.pdf') }}" style="display: inline-block;">
            ...
            <button type="submit" title="DESCARGAR PDF" class="btn btn-outline-tertiary rounded-circle ">
              <i class="fas fa-file-pdf"></i>
            </button>
          </form>
          <a href="#" title="EDITAR" class="btn btn-outline-primary rounded-circle editRating-link">
            <i class="fas fa-edit"></i>
            <span hidden>{{ $rating->rpId }}</span>
            <span hidden>{{ $rating->rpStudent_id }}</span>
            <span hidden>{{ $rating->rpAcademicperiod_id }}</span>
          </a>
          <a href="#" title="ELIMINAR" class="btn btn-outline-tertiary rounded-circle  deleteRating-link">
          ...
          <div class="row text-center newRatingDetails" style="display: none;">
            <div class="col-md-12 p-4">
              ...
              <div class="row text-left">
                ...
                <div class="col-md-2">
                  <div class="form-group form-inline pt-4">
                    <a href="#" id="plusObservationhealt" class="btn btn-outline-primary form-control-sm" title="AGREGAR OBSERVACION DE SALUD"><i class="fas fa-plus"></i></a>
                  </div>
                </div>
              </div>
              <div class="row text-left">
              ...
              <div class="row text-left">
                ...
                <div class="col-md-2">
                  <div class="form-group form-inline pt-4">
                    <a href="#" id="plusProfessionalhealt" class="btn btn-outline-primary form-control-sm" title="AGREGAR PROFESIONAL DE LA SALUD"><i class="fas fa-plus"></i></a>
                  </div>
                </div>
              </div>
              <div class="row text-left">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <button type="submit" class="btn btn-outline-success form-control-sm btn-saveRating">GUARDAR VALORACION</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row text-center">
            <div class="col-md-12 p-4">
              ...
              <div class="row text-left">
                ...
                <div class="col-md-2">
                  <div class="form-group form-inline pt-4">
                    <a href="#" id="plusObservationhealtEdit" class="btn btn-outline-primary form-control-sm" title="AGREGAR OBSERVACION DE SALUD"><i class="fas fa-plus"></i></a>
                  </div>
                </div>
              </div>
              <div class="row text-left">
              ...
              <div class="row text-left">
                ...
                <div class="col-md-2">
                  <div class="form-group form-inline pt-4">
                    <a href="#" id="plusProfessionalhealtEdit" class="btn btn-outline-primary form-control-sm" title="AGREGAR PROFESIONAL DE LA SALUD"><i class="fas fa-plus"></i></a>
                  </div>
                </div>
              </div>
              <div class="row text-left">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <button type="submit" class="btn btn-outline-primary form-control-sm btn-editRating">ACTUALIZAR VALORACION</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-12 p-4">
            ...
            <form class="row text-center" action="{{ route('ratingPeriod.delete') }}" method="POST">
              ...
              <div class="col-md-12">
                ...
                <button type="submit" class="btn btn-outline-tertiary  form-control-sm btn-editRating">ELIMINAR VALORACION</button>
              </div>
            </form>
          </div>
        </div>
        ...
        if (objectRating != null) {
          ...
          if (objectRating['rpObservationshealth'].length >= 3) {
            ...
            for (var i = 0; i < separatedObservations.length; i++) {
              $.get("{{ route('getObservationhealth') }}", {
                ohId: separatedObservations[i]
              }, function(objectObservationhealth) {
            ...
            $.get("{{ route('getObservationhealth') }}", {
              ohId: objectRating['rpObservationshealth']
            }, function(objectObservationhealth) {
              if (objectObservationhealth != null) {
                $('.navObservationshealthEdit').append(
                  "<li class='" + objectObservationhealth['ohId'] + "' style='font-size: 12px;'>" + objectObservationhealth['ohObservation'] + "<a href='#' title='QUITAR' class='plusListEdit ml-3' style='color: #ff5500'><i class='fas fa-minus-circle'></i></a></li>"
          ...
          if (objectRating['rpProfessionaslhealth'].length >= 3) {
            ...
            for (var i = 0; i < separatedProfessionals.length; i++) {
              $.get("{{ route('getProfessionalhealth') }}", {
                phId: separatedProfessionals[i]
              }, function(objectProfessionalhealth) {
            ...
            $.get("{{ route('getProfessionalhealth') }}", {
              phId: objectRating['rpProfessionaslhealth']
            }, function(objectProfessionalhealth) {
    ...
    if (rpId != '') {
      ...
      $.get("{{ route('getRating') }}", {
        ...
        if (objectRating != null) {
          ...
          for (var i = 0; i < separatedVaccination.length; i++) {
            var vaccination = separatedVaccination[i].split('=');
            $.get("{{ route('getVaccinations') }}", {
              vaId: vaccination[0],
              vaStatus: vaccination[1]
            }, function(objectVaccination) {

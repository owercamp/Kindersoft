...
@section('logisticModules')
	<div class="col-md-12 p-3">
		<div class="row border-bottom mb-3">
			...
			<div class="col-md-4">
				<button type="button" title="NUEVO ESQUEMA" class="bj-btn-table-add form-control-sm newVaccination-link">NUEVO ESQUEMA</button>
			</div>
			<div class="col-md-4">
		...
		<table id="tableDatatable" class="table table-hover text-center" width="100%">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="#" title="EDITAR" class="bj-btn-table-edit editVaccination-link">
							<i class="fas fa-edit"></i>
							<span hidden>{{ $vaccination->vaId }}</span>
							<span hidden>{{ $vaccination->vaName }}</span>
						</a>
						<a href="#" title="ELIMINAR" class="bj-btn-table-delete deleteVaccination-link">

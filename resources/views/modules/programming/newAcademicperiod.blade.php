...
@section('academicModules')
	<div class="col-md-12">
		<div class="row">
			...
			<div class="col-md-6">
				<a href="{{ route('academicperiod') }}" class="bj-btn-table-delete form-control-sm">VOLVER</a>
			</div>
		</div>
		<form action="{{ route('academicperiod.save') }}" method="POST">
			...
			<div class="row">
				<div class="col-md-12 text-center boder-top py-3">
					<div class="form-group">
						<button type="submit" class="bj-btn-table-add form-control-sm mt-4">ESTABLECER PERIODOS</button>
					</div>
				</div>
			</div>
		</form>

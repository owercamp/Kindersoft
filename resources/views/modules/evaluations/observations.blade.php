...
@section('academics')
	<div class="col-md-12">
		<div class="row mb-3 border-bottom py-3">
			...
			<div class="col-md-4">
				<a href="#" class="bj-btn-table-add form-control-sm newObservation-link">REGISTRAR OBSERVACION</a>
			</div>
			<div class="col-md-4">
			...
			<tbody>
				@foreach($observations as $observation)
					<tr>
						...
						<td>
							<a href="#" class="bj-btn-table-edit editObservation-link" title="EDITAR">
							...
							<a href="#" class="bj-btn-table-delete deleteObservation-link" title="ELIMINAR">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<select name="obsIntelligence_id" class="form-control form-control-sm" required>
					...
					<form action="{{ route('observation.update') }}" method="POST">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									<small class="text-muted">INTELIGENCIA:</small>
									<select name="obsIntelligence_idEdit" class="form-control form-control-sm" required>
										<option value="">Seleccione una inteligencia...</option>
										@foreach($intelligences as $intelligence)
											<option value="{{ $intelligence->id }}">{{ $intelligence->type }}</option>
										@endforeach

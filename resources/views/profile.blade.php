          ...
          <div class="col-md-6 border-right py-3 px-3">
            ...
            <form action="{{ route('changePassword') }}" method="POST" class="p-3">
              ...
              <div class="row text-center px-4 py-4">
                <div class="col-md-12">
                  <button type="submit" class="btn btn-outline-success form-control-sm">ACTUALIZAR MIS DATOS</button>
                </div>
              </div>
            </form>
          </div>
          ...
          <div class="col-md-12">
            <form action="{{ route('garden.new') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select name="garCity" class="form-control form-control-sm  w-100" required>
                      <option value=""></option>
                  ...
                  <div class="form-group">
                    ...
                    <select name="garLocation" class="form-control form-control-sm  w-100" required>
                      <option value=""></option>
                  ...
                  <div class="form-group">
                    ...
                    <select name="garDistrict" class="form-control form-control-sm  w-100" required>
                      <option value=""></option>
                      <!-- Barrios dinamicos -->
                    </select>
                  </div>
              ...
              <div class="row text-center">
                <div class="col-md-12">
                  <div class="form-group">
                    <button type="submit" class="btn btn-outline-success mx-3 form-control-sm">GUARDAR DATOS</button>
                  </div>
                </div>
              </div>
            </form>
            ...
            <form action="{{ route('garden.update') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <small class="text-muted">CIUDAD:</small>
                    <select name="garCity_update" class="form-control form-control-sm  w-100" required>
                      <option value=""></option>
                      @foreach($citys as $city)
                  ...
                  <div class="form-group">
                    <small class="text-muted">LOCALIDAD:</small>
                    <select name="garLocation_update" class="form-control form-control-sm  w-100" required>
                      <option value=""></option>
                      <!-- Localidades dinamicas -->
                    </select>
                  </div>
                  <div class="form-group">
                    <small class="text-muted">BARRIO:</small>
                    <select name="garDistrict_update" class="form-control form-control-sm  w-100" required>
                      <option value=""></option>
                      <!-- Barrios dinamicos -->
                    </select>
                  </div>
              ...
              <div class="row text-center">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-outline-success mx-3 form-control-sm">GUARDAR CAMBIOS</button>
                  </div>
                </div>
              </div>
            </form>

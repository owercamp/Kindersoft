		...
		<form action="{{ route('additional.new') }}" method="POST">
							...
							<div class="col-md-12 section-all">
								<div class="row section-how">
									...
									<div class="col-md-4 text-left section-btn-items">
										<button type="button" class="bj-btn-table-edit form-control-sm btn-items-plus-admissions" title="AÑADIR ADMISIÓN">
											<i class="fas fa-plus"></i>
										</button>
										<button type="button" class="bj-btn-table-delete form-control-sm btn-items-minus-admissions" title="QUITAR ADMISIÓN">
						...
						<div class="row border-top border-bottom p-3" style="background: #fff;">
							<div class="col-md-12 section-all">
								<div class="row section-how">
									...
									<div class="col-md-4 text-left section-btn-items">
										<button type="button" class="bj-btn-table-edit form-control-sm btn-items-plus-journeys" title="AÑADIR JORNADA">
											<i class="fas fa-plus"></i>
										</button>
										<button type="button" class="bj-btn-table-delete form-control-sm btn-items-minus-journeys" title="QUITAR JORNADA">
											<i class="fas fa-minus"></i>
										</button>
									</div>
							   	</div>
						...
						<div class="row border-top border-bottom p-3" style="background: #fff;">
							<div class="col-md-12 section-all">
								<div class="row section-how">
									...
									<div class="col-md-4 text-left section-btn-items">
										<button type="button" class="bj-btn-table-edit form-control-sm btn-items-plus-feedings" title="AÑADIR ALIMENTACION">
											<i class="fas fa-plus"></i>
										</button>
										<button type="button" class="bj-btn-table-delete form-control-sm btn-items-minus-feedings" title="QUITAR ALIMENTACION">
											<i class="fas fa-minus"></i>
										</button>
									</div>
							   	</div>
						...
						<div class="row border-top border-bottom p-3" style="background: #fff;">
							<div class="col-md-12 section-all">
								<div class="row section-how">
									...
									<div class="col-md-4 text-left section-btn-items">
										<button type="button" class="bj-btn-table-edit form-control-sm btn-items-plus-uniforms" title="AÑADIR UNIFORME">
											<i class="fas fa-plus"></i>
										</button>
										<button type="button" class="bj-btn-table-delete form-control-sm btn-items-minus-uniforms" title="QUITAR UNIFORME">
											<i class="fas fa-minus"></i>
										</button>
									</div>
							   	</div>
						...
						<div class="row border-top border-bottom p-3" style="background: #fff;">
							<div class="col-md-12 section-all">
								<div class="row section-how">
									...
									<div class="col-md-4 text-left section-btn-items">
										<button type="button" class="bj-btn-table-edit form-control-sm btn-items-plus-supplies" title="AÑADIR MATERIAL ESCOLAR">
											<i class="fas fa-plus"></i>
										</button>
										<button type="button" class="bj-btn-table-delete form-control-sm btn-items-minus-supplies" title="QUITAR MATERIAL ESCOLAR">
											<i class="fas fa-minus"></i>
										</button>
									</div>
							   	</div>
						...
						<div class="row border-top border-bottom p-3" style="background: #fff;">
							<div class="col-md-12 section-all">
								<div class="row section-how">
									...
									<div class="col-md-4 text-left section-btn-items">
										<button type="button" class="bj-btn-table-edit form-control-sm btn-items-plus-extratime" title="AÑADIR TIEMPO ADICIONAL">
											<i class="fas fa-plus"></i>
										</button>
										<button type="button" class="bj-btn-table-delete form-control-sm btn-items-minus-extratime" title="QUITAR TIEMPO ADICIONAL">
											<i class="fas fa-minus"></i>
										</button>
									</div>
							   	</div>
						...
						<div class="row border-top border-bottom p-3" style="background: #fff;">
							<div class="col-md-12 section-all">
								<div class="row section-how">
									...
									<div class="col-md-4 text-left section-btn-items">
										<button type="button" class="bj-btn-table-edit form-control-sm btn-items-plus-extracurriculars" title="AÑADIR EXTRACURRICULAR">
											<i class="fas fa-plus"></i>
										</button>
										<button type="button" class="bj-btn-table-delete form-control-sm btn-items-minus-extracurriculars" title="QUITAR EXTRACURRICULAR">
											<i class="fas fa-minus"></i>
										</button>
									</div>
							   	</div>
						...
						<div class="row border-top border-bottom p-3" style="background: #fff;">
							<div class="col-md-12 section-all">
								<div class="row section-how">
									...
									<div class="col-md-4 text-left section-btn-items">
										<button type="button" class="bj-btn-table-edit form-control-sm btn-items-plus-transports" title="AÑADIR TRANSPORTE">
											<i class="fas fa-plus"></i>
										</button>
										<button type="button" class="bj-btn-table-delete form-control-sm btn-items-minus-transports" title="QUITAR TRANSPORTE">
											<i class="fas fa-minus"></i>
										</button>
									</div>
							   	</div>
			...
			<div class="row text-center">
				<div class="col-md-12">
					...
					<button type="submit" class="bj-btn-table-add form-control-sm btnSaveAutorized">REGISTRAR AUTORIZACION</button>
				</div>
			</div>
		</form>
@endsection
...
@section('scripts')
	<script>
		...
		$('select[name=addCourse]').on('change',function(e){
			...
			if(courseSelected != ''){
				$.get("{{ route('getStudentFromCourse') }}",{courseSelected: courseSelected},function(objectStudents){
		...
		$('select[name=addStudent]').on('change',function(e){
			...
			if(studentSelected != ''){
				$.get("{{ route('getAttendantAdditional') }}",{studentSelected: studentSelected},function(objectAttendant){
		...
		$('.section-all').on('change','.fields-items-admissions',function(){
			...
			if(admissionSelected != ''){
				$.get("{{ route('selectedAdmissionQuotation') }}",{selectedConcept: admissionSelected},function(objectAdmission){
		...
		$('.section-all').on('change','.fields-items-journeys',function(){
			...
			if(journeySelected != ''){
				$.get("{{ route('selectedJourneyQuotation') }}",{selectedConcept: journeySelected},function(objectJourney){
		...
		$('.section-all').on('change','.fields-items-feedings',function(){
			...
			if(feedingSelected != ''){
				$.get("{{ route('selectedFeedingQuotation') }}",{selectedConcept: feedingSelected},function(objectFeeding){
		...
		$('.section-all').on('change','.fields-items-uniforms',function(){
			...
			if(uniformSelected != ''){
				$.get("{{ route('selectedUniformQuotation') }}",{selectedConcept: uniformSelected},function(objectUniform){
		...
		$('.section-all').on('change','.fields-items-supplies',function(){
			...
			if(supplieSelected != ''){
				$.get("{{ route('selectedSupplieQuotation') }}",{selectedConcept: supplieSelected},function(objectSupplie){
		...
		$('.section-all').on('change','.fields-items-extratime',function(){
			...
			if(extratimeSelected != ''){
				$.get("{{ route('selectedExtratimeQuotation') }}",{selectedConcept: extratimeSelected},function(objectExtratime){
		...
		$('.section-all').on('change','.fields-items-extracurriculars',function(){
			...
			if(extracurricularSelected != ''){
				$.get("{{ route('selectedExtracurricularQuotation') }}",{selectedConcept: extracurricularSelected},function(objectExtracurricular){
		...
		$('.section-all').on('change','.fields-items-transports',function(){
			...
			if(transportSelected != ''){
				$.get("{{ route('selectedTransportQuotation') }}",{selectedConcept: transportSelected},function(objectTransport){

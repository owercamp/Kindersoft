  ...
  <div class="card col-md-12">
    <form action="{{ route('customer.update',$customer->id) }}" method="POST">
      ...
      <div class="card-body col-md-12">
        ...
        @if($scheduling < 1) <small class="text-muted">CON: <span class="badge badge-warning">{{ $scheduling }}</span> AGENDAMIENTOS EN SU HISTORIAL</small>
          @else
      ...
      <div class="card-footer">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <a href="{{ route('customers') }}" class="btn btn-outline-tertiary  form-control-sm">VOLVER</a>
          </div>
        </div>
      </div>
    </form>

...
<body>
  ...
  <header>
    <table width="100%">
      <tr>
        <td class="text-right"><small class="text-muted text-right"><b>Docente:</b></small></td>
        <td class="text-left"><small class="text-muted text-left">{{ $collaborator->nameCollaborator }}</small></td><!-- Curso -->
        <td colspan="2" class="text-right">
          <small class="text-muted text-right">CRONOGRAMA POR DOCENTE ENCARGADO</small>
        </td>
      </tr>
      <tr>
  ...
  <table width="100%" class="text-center">
    <tr>
      ...
      <td><small class="text-muted"><b>RANGO</b></small></td>
    ...
    <tr>
      ...
      <td><small class="text-muted">{{ $result->apNameperiod }} <br> SEMANA: {{ $result->chNumberWeek }} </small></td>
      @php

...
<body>
  ...
  @for( $i = 0 ; $i < count($initialDates) ; $i++ ) <table width="100%">
    <tr>
    ...
    <tr>
      ...
      <td colspan="9">
        <small class="text-muted text-right">{{ $initialDates[$i][4] }}
          << /small>
            <!-- Nombre de acudiente -->
      </td>
    </tr>
    ...
    @php $count = 0; @endphp
    @for( $f = 0 ; $f < count($allfacturations) ; $f++ ) @if($allfacturations[$f][0]==$initialDates[$i][0]) <tr>
      <td colspan="2">

  ...
  <table width="100%">
    ...
    <tr>
      <td colspan="2" style="text-align: justify;">
        ...
        <ul>
          @for($o = 0; $o < count($observations); $o++) <li>{{ $observations[$o] }}</li>
            @endfor
        </ul>
      </td>
    </tr>
    <tr>
      <td colspan="2" style="text-align: justify;">
        ...
        <ul>
          @for($v = 0; $v < count($vaccinations); $v++) <li>{{ $vaccinations[$v][0] . ' - ' . $vaccinations[$v][1] }}</li>
            @endfor
        </ul>
      </td>
    </tr>
    <tr>
      <td colspan="2" style="text-align: justify;">
        ...
        <ul>
          @for($p = 0; $p < count($professionals); $p++) <li>{{ $professionals[$p] }}</li>
            @endfor
        </ul>
      </td>
    </tr>

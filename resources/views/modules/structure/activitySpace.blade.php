...
<div class="col-md-12">
  <div class="row border-bottom mb-3">
    <div class="col-md-6">
      ...
      <a href="#" title="AGREGAR" class="btn btn-outline-success form-control-sm newActivitySpace-link">AGREGAR ESPACIO</a>
    </div>
    <div class="col-md-6">
  ...
  <table id="tableactivityspace" class="table table-hover text-center">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="#" title="EDITAR" class="btn btn-outline-primary rounded-circle editActivitySpace-link">
          ...
          <a href="#" title="ELIMINAR" class="btn btn-outline-tertiary rounded-circle  deleteActivitySpace-link">

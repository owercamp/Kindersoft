...
@section('eventsModules')
	<div class="col-md-12 p-3">
		<div class="row border-bottom mb-3">
			...
			<div class="col-md-4">
				<button type="button" title="NUEVO AGENDAMIENTO" class="bj-btn-table-add form-control-sm newEventDiary-link">NUEVO AGENDAMIENTO</button>
			</div>
			<div class="col-md-4">
		...
		<table id="tableDatatable" class="table table-hover text-center" width="100%">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="#" title="EDITAR" class="bj-btn-table-edit editEventDiary-link">
						...
						<a href="#" title="ELIMINAR" class="bj-btn-table-delete deleteEventDiary-link">
				...
				<div class="modal-body">
					<form action="{{ route('diary.save') }}" method="POST">
						...
						<div class="form-group text-center">
							<button type="submit" class="bj-btn-table-add form-control-sm">GUARDAR AGENDAMIENTO</button>
						</div>
					</form>
				</div>
			</div>
...
@section('scripts')
	<script>
		...
		$('.deleteEventDiary-link').on('click',function(e){
			...
			if(edStudent != null){
				$.get("{{ route('getStudentDiary') }}",{id: edStudent},function(objectStudent){

...
<body>
  ...
  <hr>
  @for($i = 0; $i < count($result); $i++) @php $total=0; @endphp <table width="100%" class="table-striped text-center" style="text-align: center; font-size: 12px;" cellpadding="2">
    <thead>
      <tr>
    ...
    <tbody>
      ...
      @for($f = 0; $f < count($result[$i][2]); $f++) @php $total +=$result[$i][2][$f][2]; @endphp <tr>

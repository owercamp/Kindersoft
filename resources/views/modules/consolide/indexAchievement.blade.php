			...
			<form id="formAchievementNew" action="{{ route('achievementConsolide.new') }}" method="POST">
				...
				<div class="card-header">
				  	<div class="row">
				  		...
				  		<div class="col-md-6"><!-- SELECCION DE LOGRO -->
				...
				<div class="card-header">
					<div class="row">
						<div class="col-md-4 justify-content-center">
							<button id="saveConsolidated" type="submit" class="bj-btn-table-add m-4 form-control-sm">PROGRAMAR</button>
						</div>
						<div class="col-md-4">
							<div class="alert messages"></div>
						</div>
						<div class="col-md-4">
							<a href="{{ route('consolidatedAchievements.all') }}" class="bj-btn-table-edit m-4 form-control-sm">TABLA GENERAL</a>
						</div>
					</div>
				</div>
			</form>
	...
	<script>
		$(document).ready(function(){
			...
			$("#period_id").on("change", function(e){
				...
				$.get('subranges', {period: period_id, grade: grade_id}, function(rangesObject){

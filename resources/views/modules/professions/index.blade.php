			...
			<tbody>
				...
				@foreach($professions as $profession)
					<tr>
						...
						<td><a href="{{ route('profession.edit', $profession->id) }}" title="EDITAR" class="bj-btn-table-edit"><i class="fas fa-edit"></i></a></td>
						<td><a href="{{ route('profession.delete', $profession->id) }}" title="ELIMINAR" class="bj-btn-table-delete" onclick="return confirm('- Se eliminará la profesión')"><i class="fas fa-trash-alt"></i></a></td>
					</tr>
				@endforeach
			</tbody>
			<tfoot>

			...
			<tbody>
				...
				@foreach($admissions as $admission)
					<tr>
						...
						<td>
							<a href="{{ route('admission.edit',$admission->id) }}" title="EDITAR" class="bj-btn-table-edit"><i class="fas fa-edit"></i></a>
							<!--<a href="{{ route('admission.delete',$admission->id) }}" title="EDITAR" class="bj-btn-table-delete edit-city" onclick="return confirm('¿Desea eliminar el concepto de admisión y los regitros relacionados?')"><i class="fas fa-trash-alt"></i></a>-->
						</td>
					</tr>
				@endforeach
			</tbody>

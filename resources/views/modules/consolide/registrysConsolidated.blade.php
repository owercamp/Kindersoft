...
<div class="col-md-12 bj-scroll">
  <div class="row justify-content-center">
    ...
    <div class="col-md-6">
      <a href="{{ route('achievementsAcademics') }}" class="btn btn-outline-tertiary  my-4 form-control-sm">REGISTRAR PROGRAMA</a>
    </div>
  </div>
  <table id="tableconsolideachievements" class="table table-responsive table-hover text-center" style="width:100%;">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <!--<a href="{{ route('consolideAchievement.edit', $allAchievement->id) }}" title="EDITAR" class="btn btn-outline-primary"><i class="fas fa-edit"></i></a>--><a href="{{ route('consolideAchievement.delete', $allAchievement->id) }}" title="ELIMINAR" class="btn btn-outline-tertiary rounded-circle " onclick="return confirm('¿Desea eliminar el logro establecido?')"><i class="fas fa-trash-alt"></i></a>
        </td>
      </tr>
      @endforeach
    </tbody>

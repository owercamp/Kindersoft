	...
	<div class="col-md-12">
		<div class="row my-3 border-bottom">
			<div class="col-md-6">
				...
				<a href="#" class="bj-btn-table-add form-control-sm mb-3 mx-3 pdfAssistance-link">DESCARGA DE ASISTENCIAS</a>
			</div>
			<div class="col-md-6">
		...
		<div class="row text-center border-bottom py-2">
			<div class="col-md-6">
				<button type="button" class="bj-btn-table-edit form-control-sm btnAddAssistance">AÑADIR</button>
			</div>
			<div class="col-md-6">
		...
		<div class="row text-center border-top my-2">
			<div class="col-md-12 py-4">
				<button type="button" class="bj-btn-table-add form-control-sm btnAssistanceFinal">FINALIZAR ASISTENCIA</button>
			</div>
		</div>
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<div class="modal-footer text-center">
						<div class="row ">
							<div class="col-md-12">
								<button type="submit" class="bj-btn-table-add form-control-sm float-left  mx-4 saveAssistance">CONTINUAR</button>
				...
				<div class="modal-content">
					...
					<form action="{{ route('assistances.pdf') }}" method="GET" autocomplete="off">
						...
						<div class="modal-footer text-center">
							<div class="row">
								<div class="col-md-12">
									<button type="submit" class="bj-btn-table-add form-control-sm float-left  mx-4">DESCARGAR</button>
									<button type="button" class="bj-btn-table-delete form-control-sm float-right mx-4" data-dismiss="modal">CANCELAR</button>
								</div>
							</div>
						</div>
...
@section('scripts')
	<script>
		...
		$('select[name=assStudent]').on('change',function(e){
			...
			if(studentSelected != ''){
				$.get("{{ route('getJourneyFromStudent') }}",{studentSelected: studentSelected},function(objectJourney){
		...
		$('.btnAssistanceFinal').on('click',function(e){
			...
			if(countRow > 0){
				...
				if(students != '' && students.length > 0){
					var date = new Date();
					$.get("{{ route('getValidateAssistance') }}",{students:students, course:courseSelected, day:date.getDay()},function(objectStudents){
